...
def setLogs(logfile):
    ...
    return log
log = setLogs('SustainabilityScraper.log')
...
all_links=df['Company sustainability / ESG reports page URL'].to_list() #+ df['Company sustainability / ESG reports page URL'].to_list()
                                        ...
                                        try:
                                            ...
                                            for s in sentence_list:
                                                ...
                                                if sy:
                                                    ...
                                                    x=x+1
                                                    s_count+=1
                                                    output_df.to_csv("Test_output-extra-2_sustain.csv",index=False)
                                        except Exception as e:
                                            pass
